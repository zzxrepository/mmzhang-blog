    ...
    children: [
      {
        ...
        children: [
          ...
          { text: "Kimichat", link: "https://kimichat.com/" }, 
          { text: "豆包", link: "https://www.doubao.com/" }, 
          { text: "元宝", link: "https://yuanbao.com/" }, 
          ...
          { text: "质谱", link: "https://www.zhipuai.com/" }, 
        ],
      },
    ],
  },
    ...
    children: [
      {
        ...
        children: [
          ...
          { text: "阿里百炼", link: "https://llm.aliyun.com/" },
          { text: "火山引擎", link: "https://www.volcengine.com/" },
          { text: "Kimichat API", link: "https://kimichat.com/api" },
